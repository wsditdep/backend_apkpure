...
import { withdrawalRemarkUpdate } from '@/app/actions/remark/action';

const UpdateWithdrawalRemark = ({ data, setIsUpdate }) => {
    ...
    const handleForm = async () => {
        ...
        formData.append("iid", data?.iid);
        formData.append("remark", remark);

        try {
            const response = await withdrawalRemarkUpdate(formData);
...
export default UpdateWithdrawalRemark;